...
int ili9341_write(ILI9341* device, const uint8_t *data);
int ili9341_write_partial_direct(ILI9341* device, const uint8_t *buffer, uint16_t x, uint16_t y, uint16_t width, uint16_t height);
int ili9341_write_partial(ILI9341* device, const uint8_t *buffer, uint16_t x, uint16_t y, uint16_t width, uint16_t height);

int ili9341_select(ILI9341* device, const bool mode);
